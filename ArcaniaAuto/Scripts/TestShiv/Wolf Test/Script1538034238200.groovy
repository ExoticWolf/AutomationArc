...
WebUI.click(findTestObject('Object Repository/i_icon-crm'))

WebUI.click(findTestObject('Object Repository/a_Schedules'))

WebUI.click(findTestObject('Page_Arcania - Schedule/span_mdl-button__ripple-contai'))
